...
public class GuidoCode extends NarwhalRobot {
	...
	protected void constructHardware()
	{
        ...
        rightDriveFront = new TalonSRX(10);
        //rightDriveMiddle = new TalonSRX(1);
        rightDriveBack = new TalonSRX(11);

        leftDriveFront = new TalonSRX(20);
        //leftDriveMiddle = new TalonSRX(4);
        leftDriveBack = new TalonSRX(21);
    ...
    public static void main(String... args) {
        RobotBase.startRobot(GuidoCode::new);
    }
}